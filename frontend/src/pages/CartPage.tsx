					...
					<div className="w-11/12 mx-auto mb-8">
						...
						{cartItems && (
							<div className="flex items-start flex-col justify-between lg:flex-row">
								<div className="w-full border rounded-3xl p-8 lg:w-2/3">
									<div className="flex justify-between items-center">
										<div className="flex items-end">
											<h1 className="font-semibold text-2xl">Cart</h1>
											<p className="text-gray-500 text-sm mb-1 ml-2">
								...
								<div className="w-full mt-4 bg-gray-200 rounded-3xl lg:w-2/3 md:mt-0 md:ml-4 flex lg:block">
									<form className="relative h-full w-11/12 mx-auto my-4">
										...
										<div className="relative">
											<input
												...
												className="w-full bg-transparent text-blac border border-gray-300 rounded-full px-8 py-3 focus:outline-none"
											/>
											<button className="absolute right-2 top-1 rounded-3xl bg-black text-light px-8 py-2 font-semibold hover:bg-dark">
												Apply
											</button>
										</div>
										...
										<div className="mt-8">
											...
											<span className="flex justify-between my-4 text-gray-500">
										...
										<Link
											...
											className="flex items-center justify-center mt-4 w-full py-2 mx-auto bg-black text-light rounded-xl text-center duration-75 hover:bg-dark"
										>
											Place Order
										</Link>
									</form>
