...
import worker from "../assets/images/Bricklayer-amico.png";
	...
	return (
		<div className="flex items-center justify-center h-screen">
			<div className="w-11/12 mx-auto flex flex-col justify-center items-center py-4 md:flex-row lg:w-full">
				...
				<div>
					<h1 className="font-black text-blue text-center text-[100px] md:text-left">
						404
					</h1>
					...
					<Link
						to="/"
						className="border-2 border-blue font-semibold text-blue rounded-3xl mt-8 px-4 py-2 duration-500 hover:bg-blue hover:text-white"
					>
						Back to Home
					</Link>
				</div>
